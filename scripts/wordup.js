...
function addNewWordSubmission(word) {
    ...
    model.wordSubmissions.find(function(wordSubmission) {
...
function checkIfWordIsReal(word) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            model.wordSubmissions.forEach(function(dictStatus) {
                if (dictStatus.word == word) {
                  dictStatus.isRealWord = isRealWord;
                }
              })
...
function currentScore() {
    ...
    return wordScores.reduce(function (wordScoreTotal, wordScore) {
        return wordScoreTotal + wordScore;
    }, 0);
}
